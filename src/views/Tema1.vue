  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .col-lg-12
        .bloque-texto-g.fondo1.p-3.p-sm-4.p-md-4.my-4.otrobloque
          ...
          .bloque-texto-g__texto.py-5.px-4
            p La experiencia turística articula los elementos que se desprenden de los bienes y servicios que tienen en cuenta al turista, donde la narrativa de los hechos que han sido memorables de estos escenarios se convierten en el punto de partida para el guía que acompaña las actividades de quien visita, donde la planeación de diferentes actividades podría impactar emociones y sentimientos a través del acto comunicativo, una comunicación interpretativa que se denomina marketing; además de ello, se incorpora la comunicación persuasiva, aquella que aporta a transformación de ideas ligadas a aspectos culturales y sociales. La manera como el guía puede persuadir al turista incluye una serie de acciones desde la comunicación que incluyen elementos como la razón y la emoción. 
        ...
        .row
          .col-lg-12.mb-2
            .bloque-texto-b.color-primario.p-4
              .bloque-texto-b__texto
                i.fas.fa-quote-left
                h5.mb-0 Las racionales contienen: la argumentación, la lógica, la retórica, el método científico y la demostración; las técnicas emocionales van desde la fe, la imaginación, la fascinación o ilusión y el estímulo sensorial (López, (2015).
                i.fas.fa-quote-right
          .col-lg-12.mb-2.mb-lg-0
          ...
          .col-lg-12.mb-2
            .bloque-texto-b.color-primario.p-4
              .bloque-texto-b__texto
                i.fas.fa-quote-left
                h5.mb-0 Cuanto más intensas, más se quedan en la memoria. Los expertos aseguran que de la manera como llegue un mensaje y perdure, es cuando el consumidor lo recibe a través de varios sentidos, lo que crea un impacto más profundo. (López, 2015).
                i.fas.fa-quote-right
          .col-lg-12.mb-2.mb-lg-0
            p De esta manera, se hace necesario reconocer las áreas de los sentidos en la corteza cerebral. <b> <FONT COLOR="#FD6300"> Observe lo que se presenta a continuación: </FONT> </b>

    .bg_grad-01
      .row.justify-content-center.mb-5
        .col-lg-5
          .colorsub.p-2
            h4.text-center.text-white.mb-0 Áreas de los sentidos en la corteza cerebral
      .row.justify-content-center.mb-5
        .col-lg-10
          figure
          ...
          .cajon.color-secundario(style='background-color: #B7CEAC').p-4
            .row 
              .col-lg-1.col-md-3.col-12
                figure
                  img(src="@/assets/curso/tema1/icon1.svg", alt="alt")
              .col-lg-11.col-md-9.col-12
        ...
        .col-lg-8
          .bloque-texto-b.color-primario.p-4.mb-4
            .bloque-texto-b__texto
              ...
              i.fas.fa-quote-right
          p.mb-0 De lo anterior, se comprende la importancia de una atención de calidad desde el inicio de la compra hasta la fidelización del cliente a través del servicio de excelencia.
        .col-lg-4
          figure
    ...
    .row.mb-4
      .col-lg-8
        ...
        p.mb-0 En otras palabras, al portafolio de habilidades del guía se adiciona la necesidad de manejar tecnología que permita estar al tanto de las peticiones del usuario (aplicaciones para dispositivos móviles) e interactuar con el mismo (por correo electrónico, chats), así como, al mismo tiempo, usar las TIC en la mediación interpretativa, para presentar propuestas e, inclusive, materializarlas.
      .col-lg-4
        figure
    ...
    .row.mb-4
      ...
      .col-lg-8
        ...
        .bloque-texto-b.color-primario.p-4.mb-4
          .bloque-texto-b__texto
            i.fas.fa-quote-left
            h5.mb-0 Los expertos recomiendan una continua experimentación y prueba antes de la utilización de las TIC; si el problema persiste, revise si son los documentos o las herramientas las que no se adaptan al usuario promedio, proceda según unas pautas detalladas y prefijadas con el contratante. (Vilches y Sarmiento, 2016).
            i.fas.fa-quote-right
        ...
        .row.justify-content-center.align-items-center.my-lg-4
          .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
            .number(data-number="01")
              h4.ps-4 Contener elementos tangibles
              p.ps-4.mb-0 Es decir, el turista identifica con facilidad el mensaje con las características físicas y concretas de lo que está viendo.
          .col-8.col-lg-8
            figure
        ...
        .row.justify-content-center.align-items-center.my-lg-4
          .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
            .number(data-number="02")
              h4.ps-4 Crea conexiones intelectuales 
              p.ps-4.mb-0 Da la oportunidad al usuario de comprender conceptos e ideas nuevas.
          .col-4.col-lg-8
            figure
              img(src='@/assets/curso/tema1/slyder2.png')

        .row.justify-content-center.align-items-center.my-lg-4
          .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
            .number(data-number="03")
              h4.ps-4 Conecta emocionalmente
              p.ps-4.mb-0 Una vez conocido el mensaje, en la mente del viajero se producen emociones debidas a su grado de cultura, a sus expectativas y a su contexto.
          .col-4.col-lg-8
            figure
              img(src='@/assets/curso/tema1/slyder3.png')

        .row.justify-content-center.align-items-center.my-lg-4
          .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
            .number(data-number="04")
              h4.ps-4 Infunde una actitud de respeto
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-secundario.p-5
        .row.justify-content-center.mb-4
          .col-6
            figure
              img(src='@/assets/curso/tema1/avatar1.svg', alt='Texto que describa la imagen')
          
        h3.text-center Herramientas personales de interpretación
        p Se usan como complemento del discurso del guía, las usa para dar fuerza al mensaje. Por ejemplo, una imagen sin notas aclaratorias sirve para que el guía pueda explicar el contexto de un determinado suceso. 

      .col-md.tarjeta.color-primario.text-white.p-5
        .row.justify-content-center.mb-4
          .col-6
            figure
              img(src='@/assets/curso/tema1/avatar2.svg', alt='Texto que describa la imagen')
          
        h3.text-center Herramientas impersonales 
        p Se diseñan para que no sea necesaria la intervención del guía, se utilizan en los destinos con un alto volumen de visitas, una extensión amplia, como es el caso de los parques nacionales,  o con limitada capacidad de carga, como los observatorios de aves, para facilitar al visitante la compresión del atractivo sin la mediación del guía. Por ejemplo, en el caso del uso de la imagen, esta se ubica en un lugar visible y es acompañada de un texto. 
    ...
    .row.justify-content-center.mb-0
      ...
      .col-lg-4.col-md-10.col-12
        figure.mb-4
          img(src='@/assets/curso/tema1/fig3.svg' alt='AvatarTop')
      .col-lg-4.col-md-10.col-12
        figure.mb-4
    ...
    .row.justify-content-center.mb-4(data-aos="fade")
      .col-lg-12
        .bloque-texto-g1.color-verde.p-3.p-sm-4.p-md-5
    ...
    .row.align-items-center.mb-4
      .col-lg-8
        ...
        p.mb-0 Respecto al uso de imágenes o ilustraciones durante el servicio guiado, el guía debe preguntarse sobre:
      .col-lg-4
        figure.mb-4
    ...
    .row.mb-4
      .col-lg-8
        p.mb-2 Aunque el mapa o plano sea de calidad y diseñado por expertos, incluso si es digital, es labor del guía colocar convenciones, signos e información necesaria para que el usuario pueda comprender su ubicación y las características del destino.
        p.mb-0 Es ideal para el visitante observar las transformaciones en la naturaleza o vivir las expresiones culturales; en ocasiones, por la temporada del año o para evitar un impacto negativo, el guía puede valerse de imágenes o videos representativos que le permitan al usuario acercarse un poco más a la explicación que está dando el guía.
      .col-lg-4
        figure
    ...
    .row.justify-content-center.mb-4(data-aos="fade")
      .col-lg-12
        .bloque-texto-g1.color-verde.p-3.p-sm-4.p-md-5
          .bloque-texto-g1__img(
            :style="{'background-image': `url(${require('@/assets/curso/tema1/2.jpg')})`}"
          )
          .bloque-texto-g1__texto.p-4
    ...
    .row.align-items-center.mb-4
      .col-lg-8
        .cajon.color-primario(style='background-color: #FFE49D').p-4.mb-4
          .row.align-items-center
            .col-lg-12
              p.mb-0 El gusto es el sentido menos desarrollado, pero más íntimo, requiere una predisposición activa, voluntaria y consciente por parte del usuario. A través de los labios y la lengua, se ponen en marcha 10.000 papilas gustativas que el ser humano tiene en la boca para evaluar y mandar información al cerebro sobre la consistencia del producto, el sabor, forma, textura y temperatura, almacenando experiencias multisensoriales poderosas para la memorabilidad, pues se puede revivir un momento solo al probar nuevamente un producto (Jiménez-Marín et al., 2019). Se considera que el estilo de vida, el nivel socioeconómico y la educación de los turistas influye significativamente en el sentido del gusto.
        .row.align-items-center
          .col-lg-2
    ...
    .row.mb-4
      TabsB.color-primario
        .py-4.py-md-5(titulo="El olfato" :icono="require('@/assets/curso/tema1/olfato.svg')")
          .row
            .col-md-12.mb-4.mb-md-0
              p.mb-4 <b>El olfato</b> es el responsable de las tres cuartas partes de las emociones generadas en el turista. De hecho, estimular olfativamente a los turistas potencia su aprendizaje, porque facilita evocar recuerdos almacenados en la memoria a largo plazo. Sin embargo, el olor no es efectivo cuando se trata de recuperar información específica, porque estimula las amígdalas, responsables de la formación de las experiencias o recuerdos emocionales, influenciando directamente la toma de decisiones. 
              p.mb-4 Walt Disney fue uno de los pioneros en aplicar estímulo olfativo en su parque al impregnar los espacios de atracciones con aroma a palomitas recién hechas para promover la venta de estas. Un lugar que estimule olfativamente a sus visitantes garantiza una agradable y larga permanencia, al estar atraídos por el encantador ambiente que produce el espacio perfumado, y seguramente volverán por los buenos momentos que quedaron en su memoria. Ahora bien, si la experiencia con el aroma fue positiva, los turistas recomendarán el lugar. Un ejemplo es el Hospital USP de Marbella, donde aromatizaron el área de urgencias pediátricas con madera y notas de melocotón, y comprobaron que se logró potenciar estados de ánimo positivos y la reducción del estrés y la ansiedad tanto en pacientes como en empleados. (Jiménez-Marín et al., 2019)
              p.mb-4 Otro uso que puede darse en los recorridos es para proteger o revalorizar bienes o especies, como el caso del Cardo, que, por su apariencia espinosa y pequeña, rodeado por lo general de abejas, invita al visitante a sentir la fragancia de sus abundantes y discretas flores, y hará que el visitante entienda la importancia de su protección (Gallego, 2000). Igual sucede con los campos de lavanda españoles o el café en el eje cafetero colombiano.
              .cajon.color-primario(style='background-color: #FFDF88').p-4
                p.mb-0 El olfato, por su sensibilidad, es fácil de hostigar. Investigaciones recientes han demostrado, por ejemplo, que una exposición prolongada a un olor de un alimento procesado en el establecimiento conduce a una compra menor de ese tipo de comida o rechazo de la misma. El placer olfativo es el responsable de que los olores nos resulten agradables o desagradables, y esto depende del tono, la esencia del aroma, la intensidad, el grado de concentración y la familiaridad. Por lo tanto, puede pasar que un olor agrade al 100% del grupo. (Jiménez-Marín et al., 2019).


        .py-4.py-md-5(titulo="El tacto" :icono="require('@/assets/curso/tema1/tacto.svg')")
          .row
            .col-md-6.mb-4.mb-md-0
              p.mb-4 <b>El tacto</b> es el sentido háptico (tocar), comprende la percepción de estímulos mecánicos (aplicación de una fuerza sobre una superficie) que incluyen contacto, presión y golpeo sobre la piel, en la cual existen una serie de terminaciones nerviosas que hacen que los estímulos a través de la dermis sean interpretados de diversas maneras por el cerebro. (Jiménez-Marín et al., 2019). El tacto agradable libera la hormona oxitocina, vinculada con la sensación de calma y bienestar. Es importante anotar cómo el tacto debe guardar relación con lo observado. 
              .cajon.color-primario(style='background-color: #FFDF88').p-4
                p.mb-0 También es útil para acercar al turista a distantes y profundos hábitats de difícil acceso. Con una muestra de un alga marina o la piel de un animal, es posible explicar más fácilmente las características de una especie, lo cual es menos nocivo o impactante que entrar en el hábitat real y capturar el animal o dañar la flora, al promover la experiencia turística.
            .col-md-6
              figure
                img(src='@/assets/curso/tema1/5.jpg', alt='Texto que describa la imagen')

        .py-4.py-md-5(titulo="El oído" :icono="require('@/assets/curso/tema1/oido.svg')")
          .row
            .col-md-6.mb-4.mb-md-0
              p.mb-4 <b>El oído</b> percibe el sonido por estímulo de las áreas de la corteza cerebral y genera cambios neuroquímicos que tienen gran influencia en la conducta del usuario. Es así como la música instrumental facilita la atención y la actualización de los eventos en la memoria de largo plazo; por el contrario, la contaminación acústica que puede ser producida por música de fondo o ruidos en el ambiente puede desencadenar la necesidad de retirarse de una actividad o de un lugar, o estimular comportamiento de depresión y agresividad en el turista. (Izaguirre, 2018). 
            .col-md-6
              figure
                img(src='@/assets/curso/tema1/6.jpg', alt='Texto que describa la imagen')

        .py-4.py-md-5(titulo="La audición" :icono="require('@/assets/curso/tema1/audicion.svg')")
          .row
            .col-md-12.mb-4.mb-md-0
              p.mb-4 <b>La audición</b> es trascendental en la guianza, es fundamental, mas no imposibilitante, para el servicio, por ello es importante la distinción entre oír (percibir los sonidos a través del oído) y escuchar (prestar atención a lo que se oye). La memoria auditiva es un proceso cerebral dinámico, que codifica y almacena información relacionada con las experiencias, depende del estado emocional previo del oyente, la personalidad, así como de los intereses del individuo (Jiménez-Marín et al., 2019). 
              p.mb-4 Un buen recuerdo, una buena sensación, por ejemplo, en una caminata, puede generar un estímulo multisensorial para incrementar la memorabilidad del servicio al aumentar el aprendizaje; inicia cuando se invita al turista a contemplar el paisaje, motivándolo a identificar formas y colores, luego, a apreciar la sonoridad del lugar; y se cierra con aromas agradables que se perciben en el lugar.
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-11
        p.mb-0 Es necesario tener presente que el cerebro está especializado en extraer generalidades de los estímulos que le llegan del entorno, a través de los sentidos, y lo aprendemos sin darnos cuenta. Esta selección de generalidades depende de las experiencias que el turista acumula a lo largo de su vida. El cerebro aprende permanentemente, las 24 horas del día, es decir, el turista aprenderá las cosas o situaciones a las que les dedica tiempo, como son los viajes.
    Separador
    ...
    .row.justify-content-center.mb-4(data-aos="fade")
      .col-lg-12
        .bloque-texto-g1.color-verde.p-3.p-sm-4.p-md-5
          .bloque-texto-g1__img(
            :style="{'background-image': `url(${require('@/assets/curso/tema1/7.jpg')})`}"
          )
          .bloque-texto-g1__texto.p-4
      ...
      .col-lg-12.order-2.order-lg-1
        TabsA.color-primario.mb-5        
          .tarjeta.clr-verde.p-5(titulo="1.ª La competencia lingüística")
            h4 1.ª La competencia lingüística 
            p Hace referencia a los saberes y prácticas relativas al léxico, la fonética, la sintaxis y dimensiones generales del lenguaje.

          .tarjeta.clr-verde.p-4(titulo="2.ª La competencia sociolingüística")
            h4 2.ª La competencia sociolingüística 
            p Está relacionada con la capacidad de asimilar los parámetros socioculturales de los turistas en la utilización del lenguaje respecto a normas sociales de cortesía, de acuerdo al sexo, estatus el grupo social, y otros códigos en la comunidad a la que pertenecen los usuarios. 

          .tarjeta.clr-verde.p-4(titulo="3.ª La competencia pragmática")
            h4 3.ª La competencia pragmática 
            p Es el conocimiento de los mecanismos y soportes de la lengua, es decir, los actos de habla. De allí, la necesidad de que el guía se sensibilice sobre la importancia de fortalecer sus habilidades en relaciones humanas, liderazgo y comunicación, por tanto, realizar acciones de mejora continua en todos los aspectos de la comunicación verbal y no verbal, en los campos de la proxemia, kinestesia y lingüística. 
      ...
      .col-lg-8
        ...
        ol.lista-ol--cuadro
          ...
          li 
            .lista-ol--cuadro__vineta
              span 2
            | Un cuarto derecho: equivale a medio flanco (flanco es la vista de la parte lateral del cuerpo). 
          li 
            .lista-ol--cuadro__vineta
              span 3
            | Perfil derecho: es el flanco derecho. 
          li 
            .lista-ol--cuadro__vineta
              span 4
            | Tres cuartos derecha: equivale a un flanco y medio. 
          li 
            .lista-ol--cuadro__vineta
              span 5
          ...
          li 
            .lista-ol--cuadro__vineta
              span 6
            | Tres cuartos izquierda: es la posición opuesta a tres cuartos derecha. 
          li 
            .lista-ol--cuadro__vineta
              span 7
            | Perfil izquierdo: es el perfil opuesto al derecho.
          li 
            .lista-ol--cuadro__vineta
              span 8
    ...
    .row.mb-5
      .col-lg-2
        .row 
          .col-10
            .tarjeta.color-primario.p-2
              h4.mb-0.text-center Kinestésica
    ...
    .row.align-items-center.mb-4
      .col-lg-8
        ...
        p.mb-0 Este campo de la comunicación se podría resumir en “una imagen vale más que mil palabras”. Como lo describen Vilches y Sarmiento (2016), nuestros gestos, movimientos, nuestra ropa e incluso nuestro olor corporal también forman parte de los mensajes cuando nos comunicamos con los demás. Asimismo, cada parte del cuerpo evidencia mensajes y comunicación.<b> <FONT COLOR="#FD6300"> Algunos ejemplos: </FONT> </b> 
      ...
      .col-sm-6.col-xl-4.mb-4.mb-xl-0
        .tarjeta.tarjeta-flip.coloroscuroverd(@mouseover="indicadorTarjetaFlip = false")
          .tarjeta-flip__contenedor
            ...
            .tarjeta-flip__contenido.coloroscuroverd.p-4.p-xl-4
              h4.text-center El uso de las manos
              p.text-center Deben complementar las palabras, evite usarlas inútilmente; al hacer cualquier cosa, lo que se logra es que el receptor se distraiga, incluso movimientos violentos pueden asustar a su audiencia, aunque sus palabras sean dulces. 
    ...
    .row.mb-5
      .col-lg-2
        .row 
          .col-12
            .tarjeta.color-primario.p-2
              h4.mb-0.text-center Paralingüística
