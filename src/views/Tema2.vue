...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
        ...
        .row 
          .col-10
            .tarjeta.color-secundario.p-2
              h4.mb-0.text-center.text-white El aparato fonador y sus cuidados
    ...
    .row.justify-content-center.mb-4
      ...
      .col-lg-8
        figure
          img(src='@/assets/curso/tema2/fig1.svg', alt='Texto que describa la imagen')
    ...
    .row.align-items-center.mb-2
      .col-lg-7
        .row.align-items-center.mb-2
          ...
          .col-lg-10
            h5.mb-4 Cantar y abrir los brazos
        ...
        .row.align-items-center.mb-2
          ...
          .col-lg-10
            h5.mb-4 Alternar tres vocales, pronunciando cada una así
        ...
        .row.align-items-center.mb-2
          ...
          .col-lg-10
            h5.mb-4 Los sonidos espontáneos y su valor
