  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
          ...
          .row
            ...
            .col-lg-12.mb-4
              .bloque-texto-b.color-primario.p-4
                .bloque-texto-b__texto
                  i.fas.fa-quote-left
                  h4.mb-0 Cuanto más intensas, más se quedan en la memoria. Los expertos aseguran que de la manera como llegue un mensaje y perdure, es cuando el consumidor lo recibe a través de varios sentidos, lo que crea un impacto más profundo. (López, 2015).
                  i.fas.fa-quote-right
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-secundario.p-5
        ...
        p.text-center Se usan como complemento del discurso del guía, las usa para dar fuerza al mensaje. Por ejemplo, una imagen sin notas aclaratorias sirve para que el guía pueda explicar el contexto de un determinado suceso. 
    ...
    .row.justify-content-center
      .col-lg-4.col-md-10.col-10
        ...
        .tarjeta.colortras.px-4.py-2
          .text-center
            h4.mb-2 Figura 2
            p.mb-0 Tótem turístico
      .col-lg-4.col-md-10.col-10
        img(src='@/assets/curso/tema1/fig3.png' alt='AvatarTop')
        .tarjeta.colortras.px-4.py-2
          .text-center
            h4.mb-2 Figura 3
            p.mb-0 Catedral de sal de Zipaquirá
      .col-lg-4.col-md-10.col-10
        img(src='@/assets/curso/tema1/fig4.png' alt='AvatarTop')
        .tarjeta.colortras.px-4.py-2
          .text-center
            h4.mb-2 Figura 4
    ...
    .row.mb-4
      TabsB.color-primario
        ...
        .py-5.py-md-5(titulo="El tacto" :icono="require('@/assets/curso/tema1/tacto.svg')")
          .row.justify-content-center
        ...
        .py-5.py-md-5(titulo="El oído" :icono="require('@/assets/curso/tema1/oido.svg')")
          .row.justify-content-center
            .col-md-6.mb-4.mb-md-0
        ...
        .py-5.py-md-5(titulo="La audición" :icono="require('@/assets/curso/tema1/audicion.svg')")
          .row.justify-content-center
            .col-md-12.mb-4.mb-md-0
        ...
        TabsA.color-acento-contenido.mb-5        
          .tarjeta.clr-verde.p-5(titulo="1.ª La competencia lingüística")
            .row.justify-content-center
              ...
              .col-lg-2.col-md-2.col-6
                img(src='@/assets/curso/tema1/muñ1.png', alt='Texto que describa la imagen')
          .tarjeta.clr-verde.p-4(titulo="2.ª La competencia sociolingüística")
            .row.justify-content-center
              ...
              .col-lg-2.col-md-2.col-6
                img(src='@/assets/curso/tema1/muñ2.png', alt='Texto que describa la imagen')
